...
// Accepts serial input from pong2p.py to control both human players via MindWave 
// EEG headsets
// In this version, input from pong2p.py as attention values is used as a threshold. 
// > 50% attention = bat moves
